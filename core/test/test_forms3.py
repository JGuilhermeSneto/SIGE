...
class FormsEdgeTest(TestCase):
    ...
    def test_login_valido(self):
        user = User.objects.create_user(
            username="user", email="user@email.com", password="Senha123"
        )
    ...
    def test_professor_update_user(self):
        user = User.objects.create_user(
            username="prof", email="old@email.com", password="123456"
        )

        professor = Professor.objects.create(
            nome_completo="Prof Teste", cpf="123", user=user
        )
    ...
    def test_aluno_update_user(self):
        ...
        aluno = Aluno.objects.create(nome_completo="Aluno", cpf="123", user=user)
