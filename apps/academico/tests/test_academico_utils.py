...
class AcademicoUtilsTest(TestCase):
    ...
    def test_get_grade_horario_turma(self):
        ...
        GradeHorario.objects.create(turma=turma, disciplina=disc, dia="segunda", horario="08:00")
    ...
    def test_get_ocupados_por_professor(self):
        ...
        prof = Professor.objects.create(user=user, nome_completo="Prof", cpf="1", data_nascimento="1980-01-01")
        turma = Turma.objects.create(nome="1A", turno="manha", ano=2024)
