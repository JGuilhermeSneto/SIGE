...
urlpatterns = [
    ...
    path(
        "painel/professor/planejamentos/",
        professor_planejamento.meus_planejamentos,
        name="meus_planejamentos",
    ),
    path(
        "painel/professor/planejamentos/salvar/",
        professor_planejamento.salvar_planejamento,
    ...
    path(
        ...
        name="meus_roteiros_aluno",
    ),
    path("painel/responsavel/", paineis.painel_responsavel, name="painel_responsavel"),
    path(
        "painel/responsavel/controle-parental/",
        paineis.toggle_controle_parental,
        name="toggle_controle_parental",
    ),
    # Usuários
    path("usuarios/", registros.usuarios, name="usuarios"),
    path(
        "usuarios/desativados/", registros.listar_desativados, name="listar_desativados"
    ),
    path(
        "usuarios/desativar/<int:user_id>/",
        registros.desativar_usuario,
        name="desativar_usuario",
    ),
    path(
        "usuarios/reativar/<int:user_id>/",
        registros.reativar_usuario,
    ...
    path(
        "alunos/excluir/<int:aluno_id>/", registros.excluir_aluno, name="excluir_aluno"
    ),
    # Gestores
    path("gestores/", registros.listar_gestores, name="listar_gestores"),
    path(
        "gestores/cadastrar/",
        registros.cadastrar_editar_gestor,
        name="cadastrar_gestor",
    ),
    path(
