...
urlpatterns = [
    ...
    path(
        "desbloquear-ip/<int:ip_id>/",
        seguranca_acoes.desbloquear_ip,
        name="desbloquear_ip",
    ),
    path(
        "bloquear-usuario/<int:user_id>/",
        seguranca_acoes.bloquear_usuario,
        name="bloquear_usuario",
    ),
    path(
        "resolver-bug/<int:bug_id>/", seguranca_acoes.resolver_bug, name="resolver_bug"
    ),
    path(
        "encaminhar-ti/<int:bug_id>/",
        seguranca_acoes.encaminhar_ti,
        name="encaminhar_ti",
    ),
    ...
    path(
        "toggle-manutencao/",
        seguranca_acoes.toggle_manutencao,
        name="toggle_manutencao",
    ),
]
