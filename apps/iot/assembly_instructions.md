# 🛠️ Montagem de hardware – ESP32 + RFID (RC522)

## 📋 Componentes necessários
- **ESP32 DevKit** (ou qualquer placa ESP32 compatível)
...
- Aproxime uma tag RFID – o UID deve aparecer no console.
- Se aparecer, a conexão está correta e você pode avançar para a próxima fase (upload do código que envia dados via MQTT). 

---

### 📚 Referências úteis
- **Datasheet RC522** – fornece detalhes de alimentação e pinagem.
- **Tutorial Arduino** – https://github.com/miguelbalboa/rfid (exemplo `ReadUID`).
- **MQTT Explorer** – ferramenta gráfica para inspeção de mensagens no broker.
