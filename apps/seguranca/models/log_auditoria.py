...
class LogAuditoria(TenantModel):
    ...
    user_agent = models.TextField(blank=True, null=True, help_text="Informações do navegador/dispositivo")
    descricao = models.TextField(blank=True, null=True, help_text="Descrição detalhada da ação")
