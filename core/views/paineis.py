...
from ..utils import (
    get_nome_exibicao, get_foto_perfil, gerar_calendario,
    _get_anos_filtro, _get_grade_horario_turma
)
from ..models import Turma, Professor, Aluno, Disciplina
...
def painel_professor(request):
    ...
    from ..utils.academico import _acumular_notas_professor
...
def painel_aluno(request):
    ...
    from ..models import Disciplina, Nota, Frequencia
    from ..utils import _calcular_situacao_nota
...
def painel_usuarios(request):
    ...
    from ..utils import redirect_user
