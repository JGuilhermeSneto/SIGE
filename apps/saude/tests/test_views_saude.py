...
class SaudeViewsTest(TestCase):
    def setUp(self):
        ...
        # Ficha Médica
        self.ficha = FichaMedica.objects.create(aluno=self.aluno, tipagem_sanguinea="O+")
    ...
    def test_gestao_atestados_negado_aluno(self):
        ...
        self.assertEqual(response.status_code, 302) # Redireciona por falta de permissão (user_passes_test)
