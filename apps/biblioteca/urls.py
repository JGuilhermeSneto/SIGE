...
urlpatterns = [
    ...
    path(
        "gestao/confirmar/<int:pk>/",
        views.confirmar_retirada,
        name="confirmar_retirada",
    ),
    path(
        "gestao/devolucao/<int:pk>/",
    ...
    path(
        "api/status-leitura/",
        views.atualizar_status_leitura,
        name="atualizar_status_leitura",
    ),
    path("minhas-leituras/", views.minhas_leituras, name="minhas_leituras"),
    path(
        "leituras/aluno/<int:pk>/",
        views.minhas_leituras,
        name="historico_leituras_aluno",
    ),
]
