...
class AtividadeSeletores:
    ...
    def buscar_entregas_por_atividade(atividade_id):
        ...
        return (
            EntregaAtividade.objects.filter(atividade_id=atividade_id)
    ...
    def buscar_entrega_detalhada(entrega_id):
        ...
        return (
            EntregaAtividade.objects.select_related("aluno__user", "atividade")
            .prefetch_related("respostas__questao", "atividade__questoes__alternativas")
            .get(id=entrega_id)
        )
