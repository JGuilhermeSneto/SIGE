...
urlpatterns = [
    ...
    path(
        "historico/<int:aluno_id>/pdf/",
        relatorios.exportar_historico_pdf,
        name="exportar_historico_pdf",
    ),
    path(
        "historico/<int:aluno_id>/visualizar/",
        relatorios.visualizar_historico,
        name="visualizar_historico",
    ),
