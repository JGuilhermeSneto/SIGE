...
class GetFotoPerfilTest(TestCase):
    ...
    def test_retorna_default_sem_foto(self):
        user = MagicMock()
        user.professor = MagicMock()
        ...
        self.assertIn("default-user.png", result)

    def test_retorna_default_sem_nenhum_perfil(self):
        user = MagicMock()
        del user.professor
        del user.aluno
        del user.gestor
        self.assertIn("default-user.png", self._call(user))
...
# ===========================================================================
# 4. _calcular_situacao_nota (ex-_calcular_situacao_aluno versão 1)
# ===========================================================================
...
class CalcularSituacaoNotaFreqTest(TestCase):
    ...
    def _call(self, media, freq):
        from core.views import _calcular_situacao_nota
        return _calcular_situacao_nota(media, freq)
