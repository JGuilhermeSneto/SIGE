...
class FormsEdgeTest(TestCase):
    ...
    def test_login_senha_incorreta(self):
        User.objects.create_user(username="user2_e", email="user2_e@email.com", password="Senha123")
    ...
    def test_gestor_sem_nome(self):
        form = GestorForm(data={"cpf": "123", "senha": "Senha123", "senha_confirmacao": "Senha123"})
        self.assertFalse(form.is_valid())
        self.assertIn("nome_completo", form.errors)
