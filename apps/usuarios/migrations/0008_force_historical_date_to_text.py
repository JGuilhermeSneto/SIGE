...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        # Tabelas Históricas
        run_mysql_modify(
            "ALTER TABLE usuarios_historicalprofessor MODIFY data_nascimento LONGTEXT;"
        ),
        run_mysql_modify(
            "ALTER TABLE usuarios_historicalaluno MODIFY data_nascimento LONGTEXT;"
        ),
        run_mysql_modify(
            "ALTER TABLE usuarios_historicalgestor MODIFY data_nascimento LONGTEXT;"
        ),
        run_mysql_modify(
            "ALTER TABLE usuarios_historicalresponsavel MODIFY data_nascimento LONGTEXT;"
        ),
    ]
