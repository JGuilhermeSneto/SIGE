...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name="questao",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="academico.questao"
            ),
        ),
        migrations.AddField(
            model_name="gradehorario",
