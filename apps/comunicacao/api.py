...
class ComunicadoSerializer(serializers.ModelSerializer):
    autor_nome = serializers.CharField(
        source="autor.nome_completo", read_only=True, default="Administração"
    )
    publico_alvo_display = serializers.CharField(
        source="get_publico_alvo_display", read_only=True
    )
