# 📂 Pasta de Scripts Utilitários

Esta pasta contém ferramentas de suporte, debug e utilitários que não fazem parte do fluxo principal da aplicação, mas são úteis para manutenção e testes.
